	...
	<svelte:fragment slot="header">
		...
		<AppBar>
			...
			<svelte:fragment slot="trail">
				<a class="btn btn-sm variant-ghost-surface" href="/" rel="noreferrer"> Vote </a>
				<a class="btn btn-sm variant-ghost-surface" href="/leaderboard" rel="noreferrer">
					Leaderboard
				</a>
				<a class="btn btn-sm variant-ghost-surface" href="/console" rel="noreferrer"> Console </a>
			</svelte:fragment>
		</AppBar>
	</svelte:fragment>
	<!-- Page Route Content -->
